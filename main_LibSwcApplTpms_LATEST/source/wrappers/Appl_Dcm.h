/* -----------------------------------------------------------------------------
  Filename:    Appl_Dcm.h
  Description: Interface towards the application used by Dcm
               if no RTE is available.
               
               Do not edit this file.

  Generated by PortInterfaceExport.dll, 2017-10-20 08:47:27
 ----------------------------------------------------------------------------- */
/* -----------------------------------------------------------------------------
  C O P Y R I G H T
 -------------------------------------------------------------------------------
  Copyright (c) 2009-2017 by Vector Informatik GmbH. All rights reserved.
...
/* -----------------------------------------------------------------------------
    &&&~ RTE defined callback prototypes
 ----------------------------------------------------------------------------- */
...
/* begin file version check */
  ...
  #endif
#endif
/* end file version check */

#endif /* __APPL_DCM_H__ */
