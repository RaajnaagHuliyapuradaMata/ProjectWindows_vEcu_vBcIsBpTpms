/* file: C:/_TSS/DAG/MFA2/Target/Appl/GenData/tcbpost.h */
...
#define OS_MS2TICKS_SystemTimer(x) ((TickType)((((osTimeComputationType)(x)) * 1.00000)+0.5)) /* valid range for x: 0..4294967295 */
#define OS_TICKS2MS_SystemTimer(x) ((PhysicalTimeType)((((osTimeComputationType)(x)) * 1.00000)+0.5)) /* valid range for x: 0..4294967295 */
#define OS_NS2TICKS_SystemTimer(x) ((TickType)((((osTimeComputationType)(x)) * 1.00000e-006)+0.5)) /* valid range for x: 0..4294967295 */
#define OS_TICKS2NS_SystemTimer(x) ((PhysicalTimeType)((((osTimeComputationType)(x)) * 1.00000e+006)+0.5)) /* valid range for x: 0..4294 */
#define OS_SEC2TICKS_SystemTimer(x) ((TickType)((((osTimeComputationType)(x)) * 1000.00)+0.5)) /* valid range for x: 0..4294967 */
#define OS_TICKS2SEC_SystemTimer(x) ((PhysicalTimeType)((((osTimeComputationType)(x)) * 0.00100000)+0.5)) /* valid range for x: 0..4294967295 */
#define OS_US2TICKS_SystemTimer(x) ((TickType)((((osTimeComputationType)(x)) * 0.00100000)+0.5)) /* valid range for x: 0..4294967295 */
#define OS_TICKS2US_SystemTimer(x) ((PhysicalTimeType)((((osTimeComputationType)(x)) * 1000.00)+0.5)) /* valid range for x: 0..4294967 */
/* Counters */
...
osqROM0 extern osqROM1 const osqROM2 TaskType osqROM3 oskAlarmTask[osdNumberOfAlarms];
#endif /* (osdNumberOfAlarmActivateTask > 0) || (osdNumberOfAlarmSetEvent > 0) */

#if osdNumberOfAlarmSetEvent > 0
/* the event to set */
osqROM0 extern osqROM1 const osqROM2 EventMaskType osqROM3 oskAlarmEvent[osdNumberOfAlarms];
#endif /* osdNumberOfAlarmSetEvent > 0 */

#if osdNumberOfAlarmCallback > 0
/* alarm callback function */
osqROM0 extern osAlarmCallbackType osqROM1 const osqROM2 osqROM3 oskAlarmCallback[osdNumberOfAlarms];
#endif /* osdNumberOfAlarmCallback > 0 */

#if osdNumberOfAlarmIncrementCounter > 0
/* counter ID to increment */
osqROM0 extern osqROM1 const osqROM2 CounterType osqROM3 oskAlarmIncrementCounterID[osdNumberOfAlarms];
#endif /* osdNumberOfAlarmIncrementCounter > 0 */
...
/* END OF C:\_TSS\DAG\MFA2\Target\Appl\GenData\tcb.h */
