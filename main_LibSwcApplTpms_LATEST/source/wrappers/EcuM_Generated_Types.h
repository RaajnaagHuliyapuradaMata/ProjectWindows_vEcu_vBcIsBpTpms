...
/**********************************************************************************************************************
    Bswmd Version : 6.07.01
    Project       : HufTPMS_G6_F1L.ecuc
    Generated     : 2017-10-20 08:47 am
 
    This file is generated by  - MICROSARGEN.EXE V4.2.2.6.
 ...
 *                                ESCAN00039058 Redesign AppModeType Handling
 ...
 *                                ESCAN00057625 ASR2.1 parts removed
 ...
 * 07.07.00   2014-10-20  Vjn     ESCAN00078726 No changes here
 *                                ESCAN00079703 No changes here
 *********************************************************************************************************************/
...
/* ------------------------------------- EcuM_AppModeType Mapping to OsAppModeType --------------------------------- */
/*<ECUM_APPMODE_NAME>*/
 ...
 */
typedef CONSTP2CONST(struct EcuM_WakeupSourceDefType, TYPEDEF, ECUM_APPL_CONFIG) EcuM_WakeupSourceDefPtrType; /* PRQA S 3313 */ /* MD_ECUM_14.1_codeprotection */
...
typedef struct
{
  /* Generator version of component */
  ...
  EcuM_AppModeType DefaultAppMode_t;                        /* Default application mode for the Os.*/
...
/* module specific MISRA deviations: 
   MD_ECUM_14.1_codeprotection:
     Reason: To ensure that the ECUM local data elements are not modified from other user,
             the CONST pointer is defined to be able to use the local code. Tus the modification is not allowed.
             Otherwise the include of Mcu.h within the header file is avoided.
     Risk: n/a
     Prevention: Review; make ensure, that the defined data in EcuM_PrivateCfg.h is only used by EcuM.c
*/ 
/**********************************************************************************************************************
