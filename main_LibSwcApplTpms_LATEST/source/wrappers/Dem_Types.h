/* Kernbauer Version: 1.14 Konfiguration: Diag_AsrDem_Daimler Erzeugungsgangnummer: 1 */
 ...
 *
 *  Manufacturer: Daimler (R19)
 *  Kernbauer LL: 02.17.02
 *********************************************************************************************************************/
 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *- 01.00.05  2008-03-26  Hrs     -             Initial Version.
 *- 01.00.06  2008-03-31  Hrs     -             Convert received Odometer to 16km/bit.
 *- 01.00.07  2008-05-07  Hrs     -             Fix in core, fix AgingCounter and reported OperationCycleCounter.
 *- 01.00.09  2008-07-08  Hrs     -             Fix in core 02.01.04.
 *
 *- 02.02.01  2008-08-06  Pst     -             Update to core 3.00.00.
 *- 02.03.00  2008-09-02  Hrs    ESCAN00029570  Update DEM from Autosar R2.1 to R3.0, Compiler Abstraction, Memory Mapping.
 *-           2008-09-17  Hrs     -             Fix Star12/Cosmic problems with INLINE functions.
 *-                       Hrs    ESCAN00026182  Extension for MSR3.0 LinkTime checks
 *-                       Hrs    ESCAN00026508  Extension for MSR3.0 generator version checks
 *- 02.04.00  2008-10-10  Hrs     -             Add support for Historical Stack, HIR, callbacks for storage condition
 *                                              manager and RoE-Lite SWC, change handling to support multiple Origins,
 *                                              import DTC config from CDD.
 *-                       Hrs     -             Adapt for GenTool 2.04.00: DTCOrigin in generated differently.
 *-                       Hrs    ESCAN00029778  PreCompile and Linktime CRC check.
 *-                       Hrs     -             Implement Svc 31 01 FF02 (ClearHistoricalData).
 *- 02.04.01  2008-11-11  Hrs     -             Code rewritten to compile with the great Cosmic compiler.
 *-                                             Fix Add.Env.Data, OperationCycleCounter.
 *-           2008-11-14  Hrs    ESCAN00031296  GetIndicatorStatus returns active indicator.
 *- 02.05.00  2008-11-28  Hrs    ESCAN00031713  No diagnostic response to clear DTC request (hex: 14 FF FF FF) - compiler bug.
 *-                       Hrs    ESCAN00031703  Bsw event queue + add. queue > 255 elements leads to unpredictable data access.
 *-           2008-12-12  Hrs    ESCAN00032014  EcuM_GeneratorCompatibilityError(): CRC error due different StatusAvailabilityMask.
 *-           2008-12-15  Hrs    ESCAN00032032  Invalid RTE context for callback(s) in Dem_ResetEventStatus().
 *-                       Hrs     -             MISRA improvements.
 *-                       Hrs    ESCAN00028078  Remove unused static functions Dem_UpdateSnapshotRecord() and Dem_GetMostRecentSnapshotIndex() in Dem.c.
 *-                       Hrs    ESCAN00032293  Runtime is too long if a large event queue is configured.
 *-           2009-01-14  Pst    ESCAN00032352  Compile error Cosmic compiler caused by inline function usage.
 *-           2009-01-16  Hrs/PstESCAN00032018  Add specific error return codes for Interfaces that do their task later in Dem_MainFuction.
 *- 02.07.00  2009-03-11  Ade    ESCAN00032994  Change INLINE functions to STATIC_INLINE resp. Macro.
 *-           2009-03-25  Hrs    ESCAN00034134  Memory Abstraction: incompatible far pointer assignment in Dem_GetFreezeFrameDataIdentifierByDTC()
 *-           2009-03-27  Hrs    ESCAN00033459  Compiler Warning: condition is always true
 *- 02.08.00  2009-04-14  Hrs    ESCAN00032722  Update StatusBit Handling according latest coordination with Daimler
 *-                       Ade    ESCAN00033881  Debounce algorithm 'Time based' shall be supported
 *-           2009-05-19  Hrs    ESCAN00035255  Historical Stack overflow
 *-                       Hrs     -             Use Dem_EnableConditionStateType instead of uint32 for varying count of ECs
 *-                       Hrs     -             Remove (conditionally) not necessare variables, functions
 *-                       Hrs    ESCAN00036153  Compiler warning: unused function Dem_AddNewDTCtoChronoStack(), Dem_GetSizeOfExtendedDataRecord()
 *-                       Hrs    ESCAN00035069  Used PrimemIndex instead of ChronoIndex
 *-                       Hrs    ESCAN00035269  Wrong return value for Dem_NvDataInit() callback function
 *-                       Hrs    ESCAN00033939  Optimization of DEM queue algorithm
 *-           2009-06-22  Hrs    ESCAN00035377  Service 0x19 0x05, 0x06 runtime optimization
 *-           2009-06-26  Hrs    ESCAN00034922  Add support for multiple configuration
 *-           2009-07-06  Hrs    ESCAN00036187  pre-processor checks for building the library
 *-           2009-07-07  Hrs    ESCAN00035800  Compiler warning: undefined behavior: the order of volatile accesses is undefined
 *-           2009-07-16  Hrs    ESCAN00034178  The last known DTC Status shall be retained when a request to disable DTC setting is active.
 *-           2009-07-24  Hrs     -             MISRA improvements
 *-           2009-08-07  Hrs    ESCAN00036947  Unset (MostRecent) Extended Record was reported with 19 06/10
 *-           2009-08-12  Hrs    ESCAN00036997  More than one configuration can be activated - Rework Dem_ConfigType
 *-           2009-08-14  Hrs     -             Rework due CodeInspection
 *-           2010-10-12  Hrs    ESCAN00045946  Compiler error when using microcontroller with Paged RAM
 *- 02.08.01  2009-09-01  Pst    ESCAN00037505  Linker error: unresolved external symbol Dem_IsSupportedDtcOrigin referenced
 *-           2009-09-14  Hrs     -             Avoid MISRA violation on not using return value of Dem_AQPush() with DEM_DEV_ERROR_DETECT == STD_OFF
 *- 02.08.02  2009-10-09  Hrs    ESCAN00038303  DTCs not copied from Chrono- to HistoricalStack on Service 14 FF FF FF (Clear all DTCs)
 *-                       Hrs    ESCAN00038164  The status bits warningIndicatorRequest and pendingDTC are wrongly considered to detect status changes
 *-                       Hrs    ESCAN00038138  Incorrect behavior after calling Dem_DisableDTCRecordUpdate
 *-                       Hrs    ESCAN00038100  With configuration variant PreCompile the API Dem_GetVersionInfo was implemented as macro
 *-                       Hrs    ESCAN00038266  Unexpected positive response on requests with unsupported extended records (19 06)
 *-                       Hrs    ESCAN00038396  ServiceId 0x3d was ambivalent (is used twice as ApiId in Det_ReportError() calls)
 *-           2009-10-16  Hrs    ESCAN00038522  Extended Version Check DIAG_ASRDEM_GENTOOL_GENY_MINOR_VERSION failed
 *- 02.08.03  2009-11-03  Hrs    ESCAN00038595  Runtime optimization for implementation of service 19 02/08/0A/0F/13/14
 *- 02.08.04  2010-02-24  Hrs    ESCAN00039684  Compile error: missing compiler abstraction with cast (Dem_MaxExtendedDataRecordType *)
 *            2010-02-26  Pst    ESCAN00040734  Harmonize format of justification for MISRA violations to support CDK
 *- 02.09.00  2010-03-03  Pst     -             Code cleanup
 *-           2010-04-23  Hrs    ESCAN00042367  Negative response of DCM/CANdesc on requests 0x19 0x04/0x05/0x06 when no snapshot / extended record is stored
 *-           2010-04-26  Mhe    ESCAN00042022  Improvement: split Critical Section (short runtime + IRQ blocking vs. longer runtime + task-blocking)
 *- 02.10.00  2010-08-10  Hrs    ESCAN00043495  Add feature: Suppress DTC
 *-           2010-08-10  Hrs    ESCAN00043459  Refactoring: Reduce length of identifiers
 *-           2010-08-10  Hrs    ESCAN00044587  Sort list of API IDs
 *- 02.10.01  2010-09-29  Hrs    ESCAN00045647  Corrupted ChronoStack entries / Compiler warning: dead assignment to "Dem_StatusUpdate" eliminated
 *- 02.11.00  2010-11-22  Hrs    ESCAN00047081  Remove NvM_GetErrorStatus() from Dem_Init()
 *- 02.12.00  2010-11-29  Hrs    ESCAN00046240  Adapt AUTOSAR version check
 *-           2010-11-29  Hrs    ESCAN00045032  Unify the call sequence of Dem_TriggerOnEvent() and DemCfg_GetInitMonitorFPtr()
 *-           2010-11-29  Hrs    ESCAN00044879  DEM shall accept the ClearDTC (0x14) diagnostic service request in state ControlDTCSetting off (0x85 02)
 *-           2010-11-30  Hrs    ESCAN00047309  Avoid nesting of Compiler Abstraction macros - P2VAR(P2CONST(...), ...)
 *-           2011-01-24  Hrs    ESCAN00048036  DTC self healing was delayed by one cycle
 *- 02.13.00  2011-04-15  Hrs    ESCAN00049694  Historical interrogation record (HIR) shall not be altered in non-extended session - detect via ExternalTesterPresent signal
 *-           2011-04-28  Hrs    ESCAN00048859  Implement callback to suppress clearing of dedicated DTCs (AR 4.0 backport: ClearEventAllowed)
 *-           2011-05-02  Hrs    ESCAN00048451  Discarding of BSW events with status PASSED
 *-           2011-05-02  Hrs    ESCAN00050010  Compiler error: "incompatible pointer types"
 *-           2011-05-19  Mhe    ESCAN00048942  Use standard include guard for Dem.h: #if defined (DEM_H)
 *-           2011-05-19  Mhe    ESCAN00050539  Removal of FDC and *ThisOc for reduction of NVM Write Cycles
 *- 02.14.00  2011-05-30  Hrs    ESCAN00048027  Neg. Response ConditionNotCorrect in Diagnostic Services 19 0b, 19 0c, 19 0d, 19 0e
 *-           2011-06-17  Mhe    ESCAN00050150  The NVRAM block handling was reworked
 *-           2011-06-17  Mhe    ESCAN00051385  Removed initialization of non-initialized variable
 *-           2011-06-17  Mhe    ESCAN00051737  Remove the AUTOSAR Release Version Check
 *-           2011-07-13  Mhe    ESCAN00051401  Optimize internal implementation of indicator handling
 *-           2011-07-13  Mhe    ESCAN00051878  Time-based debouncing - DTC will not qualify 
 *-           2011-07-13  Mhe    ESCAN00051976  SuppressDTC: DET in NvM with empty or corrupt data block
 *-           2011-07-13  Mhe    ESCAN00052145  Remove DET check for a severity mask which is out of range
 *-           2011-07-19  Mhe    ESCAN00052286  Sporadic data loss after Ecu sleep
 *-           2011-08-18  Mhe    ESCAN00052694  Improve function run-time of Dem_Mem_GetDTCStatus
 *-           2011-08-18  Mhe    ESCAN00052854  Distribute ClearDTC across multiple call cycles
 *- 02.14.01  2011-11-18  Hrs    ESCAN00053509  AR3-2069: Remove non-SchM code for critical section handling
 *-           2011-11-22  Mhe    ESCAN00052895  Replace internal error code "DEM_E_INV_SFN" with "DEM_E_PARAM_DATA"
 *-           2011-11-22  Mhe    ESCAN00054761  Dem will not store DTCs after clear command
 *-           2011-11-22  Mhe    ESCAN00054878  Compiler Warning: constant out of range
 *- 02.14.02  2012-07-03  Mhe    ESCAN00059872  Dem attribute definition not AUTOSAR conform
 *-           2012-07-03  Mhe    ESCAN00059597  Improve run time when reading DTC status
 *- 02.15.00  2013-03-07  Hrs    ESCAN00065270  AR3-2454: Implement Fault Memory Requirements from MBN 10746 2011-09 (DPRS)
 *-           2013-03-25  Hrs    ESCAN00065298  AR3-2477: Implement instrumentation for time measurement
 *-           2013-03-28  Mhe    ESCAN00063220  Compiler warning: warning #193-D: zero used for undefined preprocessing identifier DEM_SUPPORT_RELEASE_LOCK_COUNTER
 *- 02.16.00  2014-01-20  Mhe    ESCAN00071284  AR3-2608: Adapt Reading of FlexRay Driver Configuration
 *- 02.17.00  2014-03-18  Mhe    ESCAN00072581  AR3-2626: Add Operating Hours to Standardized Environmental Data
 *-           2014-04-23  Mhe    ESCAN00074870  DTC age incorrectly in one operation cycle
 *- 02.17.01  2014-08-04  Mhe    ESCAN00076644  Memory corruption due to out of bounds access
 *- 02.17.02  2015-03-25  Mhe    ESCAN00081661  Memory not cleared after ClearDTC
 */
/******************************************************************************************************************/ /**
 *
 ...
 *- 02.01.03  2008-05-06  Hrs     ESCAN00026730 No parameter check in function Dem_EnableEventStatusUpdate() for invalid argument values of 'DTCKind'
 *- 02.01.04  2008-07-08  Hrs     ESCAN00028228 PrePassed/PreFailed Debounce Counter mixed up
 *- 03.00.00  2008-08-04  Hrs     ESCAN00024538 <Xxx>_DemInitMonitor{EventName} is triggered by Dem_ClearDTC() only if the DTC is stored (in PrimaryMem)
...
#endif
#define DEM_CYCLE_STATE_START_BLOCKED                     0xFF  /* Internal: Cycle is started but all operation currently blocked */
...
# define DEM_SUPPRESS_DTC_OFF                              0u   /* Event shall be reported, i.e. not suppressed */
# define DEM_SUPPRESS_DTC_ON                               1u   /* Event shall be suppressed */
# endif
#endif  /* DEM_SUPPORT_SUPPRESS_DTC */


/*
 * Enable Conditions are stored as bitfield, as different ECs can be active simultaneously.
 * Choose type according to the max number of EnableConditions in the system: 1..8->uint8, 9..16->uint16, 17..32->uint32
 */
...
/*
 * OEM specific: (Daimler)
 * DEM_DTC_ORIGIN_PRIMARY_MEMORY      ChronoStack
 * DEM_DTC_ORIGIN_SECONDARY_MEMORY    HistoricalInterrogationRecord
 * DEM_DTC_ORIGIN_MIRROR_MEMORY       HistoricalStack (optional)
 */
...
/* #define DEM_GET_DTCOFEVENT_NOT_OK                      0x01     E_NOT_OK (see Dem198) */
#define DEM_GET_DTCOFEVENT_NO_DTC_AVAILABLE               0x02  /* E_NO_DTC_AVAILABLE (see Dem198) */
