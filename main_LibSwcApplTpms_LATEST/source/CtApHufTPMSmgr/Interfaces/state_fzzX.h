...
////////////////////////////////////////////////////////////////////////////////////////////
// FAHRZEUGZUSTAND
#define cKL_15_EIN            ((uint16) 0x0001)   // Zündung ein
#define cRS_VTHRES            ((uint16) 0x0002)   // "1" => Fahrzeuggeschwindigkeit hat die Ansprechschwelle
                                                  //        für Roll-Switch überschritten
#define cFAHRZEUG_FAEHRT      ((uint16) 0x0004)   // "1" => Fahrzeug fährt nach Herstellerspez.
#define cRUECKWAERTSFAHRT     ((uint16) 0x0008)   // "1" => Fahrzeug fährt rückwärts
#define cVEH_ABSSTICKS_MOVE   ((uint16) 0x0010)   // "1" => ABS rotation detected for last 200 ms
#define cKFZFAEHRT_20KMH      ((uint16) 0x0020)   // "1" => Fahrzeug fährt v>20kmh um RE-Druck bei KAL einzusammlen
...
#define cENG_STARTING         ((uint16) 0x0200)   // wie der Name sagt - Motor läuft
#define cENG_RUNNING          ((uint16) 0x0400)   // wie der Name sagt - Motor läuft
...
#define cKL30_UEBERSPG				((uint16) 0x8000)   // wie der Name sagt - Bordnetz lt. Diagnose Spec Überspannung
#define cFZZ_ALLE_BITS        ((uint16) 0xffff)   // Maske für komplette Fahrzeugzustandsvariable
/*
