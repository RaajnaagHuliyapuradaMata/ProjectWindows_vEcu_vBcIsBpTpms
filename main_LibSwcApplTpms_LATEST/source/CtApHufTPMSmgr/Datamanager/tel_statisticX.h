...
#define FAILURE_MODE_soWE 1U // some wheel electronics
#define FAILURE_MODE_noWE 2U // no wheel electronics
...
#define cTableSize 16 // up to 20 telegramm infos to be saved
