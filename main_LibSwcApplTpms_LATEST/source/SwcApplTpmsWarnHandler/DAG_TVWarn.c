...
uint8  ui8GetTempColeurWP_FL   (void){return(ui8GetTempColeurWP(ucWPFLc));}
uint8  ui8GetTempColeurWP_FR   (void){return(ui8GetTempColeurWP(ucWPFRc));}
uint8  ui8GetTempColeurWP_RL   (void){return(ui8GetTempColeurWP(ucWPRLc));}
uint8  ui8GetTempColeurWP_RR   (void){return(ui8GetTempColeurWP(ucWPRRc));}
uint8  ui8GetTempColeurWP_UK   (void){return(ui8GetTempColeurWP(4));}
uint16 ui16GetFilterSpeedInKmh (void){return ((uint16) (ui16FilterSpeed>>7));}
uint16 ui16GetOvrHeatCt        (void){return ui16HeatCt;}
uint16 ui16GetSpeedCtInSec     (void){return ui16RedSpeedCt;}
